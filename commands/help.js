...
module.exports = {
    ...
    execute(message, args, Discord) {
            ...
            .setColor('99ffeb')
            .setDescription("Hey, I'm SheepyMod, an all purpose bot developed by Killeration and Gronky, exclusively for MrSuicideSheep Server, this bot is still in developement! :D \n \n There are three types of commands for this bot: ")
            .addFields(
