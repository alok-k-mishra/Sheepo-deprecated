module.exports = {
    ...
    execute(message, args, Discord) {const helpmem = new Discord.MessageEmbed()
        ...
        .setColor('99ffeb')
        .setDescription("Hey! I'm Sheepo, a bot developed by Killeration and Gronky, exclusively for this Discord Server! :D \n \n Here are the fun commands members can enjoy!")
        .addFields(
